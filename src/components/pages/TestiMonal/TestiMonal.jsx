...
export default function TestiMonal() {
    return (
        <>
            <div>
                <h2 className="text-2xl leading-6 text-blue-500 text-center px-4">Testimonials</h2>
                <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold px-4 leading-10 text-white mt-6 text-center">What our client says</h1>
                    ...
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
                            <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                                ...
                                <p className="xl:w-80 text-base leading-normal text-center mt-4">“I'm impressed, to me i believe there are people who should be called genius in doing what they know how to do best, when it comes to dealing with getting solutions and revealing secrets i can vouch for Hackmart's services as many times as possible because of the brilliant and superb teamwork they portrayed.</p>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-white">Developer</p>
                        </div>
                    </div>
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-white">Designer</p>
                        </div>
                    </div>
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-white">Manager</p>
                        </div>
                    </div>
                </div>
            </div>
